...
class ELK:
    def __init__(self):
        self.es = None
        self.INDEX_NAME = "RansomwareGroups"
                    ...
                    "aggs": [
                        # title 필드의 상위 값 표시
                        {
                            ...
                            "params": {
                                "field": "attacker",
                                "size": 5,  # 상위 5개의 값만 표시
                                "order": {"type": "count", "direction": "desc"}  # 내림차순 정렬
                            }
                        },
                        {
                            "id": "2",
                        ...
                        # country 필드의 상위 값 표시
                        {
                            ...
                            "params": {
                                "field": "country",
                                "size": 5,
                                "order": {"type": "count", "direction": "desc"}
                            }
                        },
                        # site 필드의 상위 값 표시
                        {
        ...
        payload = {
            "attributes": {
                ...
                "mapStateJSON": json.dumps({
                    ...
                    "timeFilters": {"from": "now-15m", "to": "now"},  # 기본 시간 필터
                ...
                "layerListJSON": json.dumps([
                    ...
                    #},
                    {
                        ...
                        "style": {
                            "type": "STATIC",  # 벡터 스타일
                            "properties": {
                                "fillColor": {"type": "STATIC", "options": {"color": "#54b399"}},  # 채우기 색상
